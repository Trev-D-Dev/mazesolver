...
class Cell:
    ...
    def draw(self, x1, y1, x2, y2):
        ...
        self.__win.draw_line(left_line, line_color)
        ...
        self.__win.draw_line(right_line, line_color)
        ...
        self.__win.draw_line(top_line, line_color)
        ...
        self.__win.draw_line(bottom_line, line_color)
